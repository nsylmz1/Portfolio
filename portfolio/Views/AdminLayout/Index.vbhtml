...
<head>
    ...
    <link href="~/sidebar-03/css/style.css" rel="stylesheet" />
</head>
<body>
        ...
        <nav id="sidebar" class="active">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled components mb-5">
                    <li class="active">
                        <a href="/Statistic/"><span class="fa fa-home mr-3"></span> İstatistik</a>
                    </li>
                    <li>
                        <a href="/Categories"><span class="fa fa-user mr-3"></span> Kategori</a>
                    </li>
                    <li>
                        <a href="/Project"><span class="fa fa-briefcase mr-3"></span> Projeler</a>
                    </li>
                    <li>
                        <a href="/Contact"><span class="fa fa-sticky-note mr-3"></span> İletişim</a>
                    </li>
                    <li>
